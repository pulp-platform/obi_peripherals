...
// tmrg tmr_error true
    ...
    logic [ADDR_DEPTH - 1:0] read_pointer_n, read_pointer_q, write_pointer_n, write_pointer_q, read_pointer_qVoted, write_pointer_qVoted;
    // keep a counter to keep track of the current queue status
    // this integer will be truncated by the synthesis tool
    logic [ADDR_DEPTH:0] status_cnt_n, status_cnt_q, status_cnt_qVoted;
    // actual memory
    logic [DATA_WIDTH-1:0] [FifoDepth - 1:0] mem_n, mem_q, mem_qVoted;
